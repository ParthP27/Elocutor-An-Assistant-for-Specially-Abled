# -*- coding: utf-8 -*-
"""
Created on Tue Sep 29 16:30:38 2020
...
#Graphics window
# imageFrame1 = tk.Frame(window, width=300, height=300)
# imageFrame1.pack(side='bottom')

imageFrame = tk.Frame(window, width=100, height=500)
...
# lmain1 = tk.Label(imageFrame1)
# lmain1.pack(side='right')
...
def show_frame():
    ...
    img = Image.fromarray(general, 'RGB')
